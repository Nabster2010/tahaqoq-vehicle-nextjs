...
const HighBeamCreateForm = ({ vehicle }) => {
  const router = useRouter();
  const { id } = router.query;
  const [highBeam, setHighBeam] = useState<any>(initialState);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`High Beam level result has been saved`);
    } catch (error) {
        ...
        <table className="min-w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
            {/* <tr className="">
              ...
              <td className="whitespace-nowrap py-4 px-3 text-sm font-medium text-gray-900 dark:text-white">
                <Indicator value={highBeam <= testLimits.highBeam} />
              </td>
            </tr> */}
            <tr className="">
              <td className="whitespace-nowrap py-4 px-3 text-sm font-medium text-gray-900 dark:text-white">
...
export default HighBeamCreateForm;
