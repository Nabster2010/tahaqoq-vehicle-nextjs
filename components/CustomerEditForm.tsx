...
import { editCustomer } from "../app/reducer/customersSlice";

const CustomerEditForm = ({ initialState }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(editCustomer({ customer, router }));
  };
  return (
    <>
      ...
      >
        ...
        <div className="col-span-6 flex flex-col gap-2 md:col-span-3 md:col-start-4  md:flex-row  lg:col-span-2 lg:col-start-5">
          <button
            onClick={() => router.back()}
            type="button"
