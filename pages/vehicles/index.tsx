                ...
                {vehicles.map((vehicle) => (
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap py-4 px-6  text-sm font-medium">
                      <Link href={`${router.route}/${vehicle.id}`}>
                    ...
                    <td className="whitespace-nowrap py-4 px-6  text-sm font-medium">
                      <Link href={`${router.route}/${vehicle.id}/result`}>
                        <a href="#" className="text-blue-700">
                          <svg
                            className="h-6 w-6"
                            fill="none"
...
//   const size = ctx.query.size ? Number(ctx.query.size) : 5;
//   const { data } = await axios.get(
//     `${process.env.API_URL}/vehicles?page=${page}&size=${size}`,
//     {
